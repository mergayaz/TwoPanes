...
class MainFragment2 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val btn1 = view.findViewById<Button>(R.id.main2_btn1)
        val btn2 = view.findViewById<Button>(R.id.main2_btn2)
        val btn3 = view.findViewById<Button>(R.id.main2_btn3)
        val btn4 = view.findViewById<Button>(R.id.main2_btn4)
        val editText = view.findViewById<EditText>(R.id.main2_edit)
        val numberView = view.findViewById<TextView>(R.id.main2_number)
        val args = arguments
        if (args != null) {
        ...
        if (container!!.id == R.id.fragment_container1) {
            ...
            btn2.setOnClickListener {
                ...
                fm.beginTransaction().add(R.id.fragment_container1, MainFragment1()).commit()
            ...
            btn1.setOnClickListener {
                ...
                val bundle = Bundle()
                bundle.putString("left_part", "main2")
