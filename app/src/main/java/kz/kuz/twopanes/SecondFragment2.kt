...
class SecondFragment2 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val btn1 = view.findViewById<Button>(R.id.second2_btn1)
        val btn2 = view.findViewById<Button>(R.id.second2_btn2)
        val btn3 = view.findViewById<Button>(R.id.second2_btn3)
        val btn4 = view.findViewById<Button>(R.id.second2_btn4)
        val editText = view.findViewById<EditText>(R.id.second2_edit)
        val numberView = view.findViewById<TextView>(R.id.second2_number)
        val args = arguments
        if (args != null) {
        ...
        if (container!!.id == R.id.fragment_container1) {
            ...
            btn4.setOnClickListener {
                ...
                fm.beginTransaction().remove(fragment!!).commit()
                fm.beginTransaction().add(R.id.fragment_container1, SecondFragment1()).commit()
            ...
            btn1.setOnClickListener {
                ...
                val bundle = Bundle()
                bundle.putString("left_part", "second2")
